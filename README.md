 ...
 [GET Базовые запросы](Req_GET_Base_Zapros.py)

 [Post отправки](Req_POST_Base.py)

 [DZ_1_PS02_GET_JSON.py](DZ_1_PS02_GET_JSON.py)

 [DZ_2_PS02_GET_FILTR.py](DZ_2_PS02_GET_FILTR.py)

 [DZ_3_PS02_POST_NEW_DATA.py](DZ_3_PS02_POST_NEW_DATA.py)
